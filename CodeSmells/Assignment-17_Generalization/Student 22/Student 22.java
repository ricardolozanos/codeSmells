...
abstract class Plotter extends NoApplet {
...
abstract class MultiPlotter extends Plotter {
    ...
    public double func(double x) {
        throw new UnsupportedOperationException("Not supported in MultiPlotter");
    }

    public abstract List<Double> funcs(double x);
    ...
    public static void main(String[] args) {
        new MultiPlotter() {
            @Override
            public List<Double> funcs(double x) {
                return null;
            }
        }.run();
    }
...
class SineCosinePlotter extends MultiPlotter {
    @Override
    public List<Double> funcs(double x) {
